                ...
                <div class="col-12 col-lg-4 offset-lg-0 col-md-12 no-padding-left">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="plan">
                            ...
                            <option value="<?=$plan->id?>"><?=$plan->name.' '.$plan->profit.'% every '.$plan->interest_interval.' for '.$plan->investment_period.' min:'.to_currency($plan->minInvestment).' max:'.to_currency($plan->maxInvestment)?></option>
                            <?php } ?>
                        </select>
...
<section class="plan-features clearfix mr-n35" id="plans">
    <div class="container">
        ...
        <div class="row align-items-center">
            <?php foreach($plans as $plan) {?>
            <div class="col-lg-4 col-md-6 col-sm-12 mt-md-30 mb-3">
                <div class="plan-block v2 txt-center">
                    ...
                    <div class="plan-percent">
                        ...
                        <p class="text-capitalize">profit every <br><?=$this->security->xss_clean($plan->interest_interval) ?></p>
                    </div>
                    <div class="plan-content">
                        <p class="title">For</p>
                        <p class="body"><?=$this->security->xss_clean($plan->investment_period) ?></p>
                    </div>
