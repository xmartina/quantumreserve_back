            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mt-md-30">
                    <div class="services-block-four v2 txt-center">
                            ...
                            <h5 class="black"><?php echo $this->security->xss_clean($plan->profit).'% every '.$this->security->xss_clean($plan->interest_interval).' for '.$this->security->xss_clean($plan->investment_period) ?></h5>
